...
5. You will receive a confirmation email and SMS once the order is placed.`,
      ...
      },
      {
        ...
        answer:
          "Don't worry! We'll assist you in resolving this issue. First, check your bank or credit card account to confirm whether the amount was debited. If the payment was deducted but the order didn't go through, the amount will be automatically reversed by your bank within 7-10 business days. For further assistance, please contact us on WhatsApp or email us at support@  Straticrestedge solutions private limited, and we'll be happy to help",
      },
      {
        question: "How should I check the status of my Order?",
        answer: `Click here to Track Your Order. If you encounter any issues or need further assistance, please contact us on WhatsApp or email us at support@  Straticrestedge solutions private limited.`,
      },
    ],
    ...
    "Cancellation & Related Queries Order Cancellation": [
      {
        ...
        answer: `What is  Straticrestedge's Cancellation Policy?
...
Please Note: The  Straticrestedge team will never ask for your personal information or banking details over the phone or via email. Please do not share your details with anyone. Only follow the secure checkout process on the website.`,
      },
...
If the amount has been debited after a payment failure, it will be automatically reversed by the respective bank within 48-72 business hours. If you do not receive the refund, please contact your bank. For any other requests or queries regarding this, please contact us on WhatsApp or email us at support@  Straticrestedge solutions private limited, and we'll be happy to help.`,
      },

      {
        question: "What is  Straticrestedge Wallet?",
        answer:
          " Straticrestedge Wallet is a digital platform where COD refunds are credited. It is designed to offer flexibility and ease in redeeming benefits on future purchases. You can use this balance to shop from  Straticrestedge within 12 months.",
      },
      ...
      {
        question:
          "Can I use my  Straticrestedge wallet balance for offline store purchases?",
        answer:
          "No, the  Straticrestedge wallet balance can only be used for online purchases on the  Straticrestedge website or app.",
      },

      {
        question: "Does  Straticrestedge wallet balance expire?",
        answer:
          "Yes, the  Straticrestedge wallet balance has a validity period of 12 months from the date of credit.",
      },

      {
        question:
          "Can I transfer the  Straticrestedge wallet balance to my friend’s  Straticrestedge Wallet?",
        answer:
          "No, the  Straticrestedge wallet balance is non-transferable and non-refundable.",
      },
    ],

    "Shipping & Tracking": [
      {
        question: "What is the Shipping Policy of  Straticrestedge?",
...
Your refund request will be created.`,
      ...
      {
        question:
          "Can I return an online purchase to the  Straticrestedge Store?",
        answer: `No, you can not return an online purchase to the  Straticrestedge Store.`,
      },
      {
...
10. Click on “Confirm and Pay”.`,
      ...
      },
      {
        ...
        answer: `For prepaid orders, you can choose between receiving a refund via your original payment method or  Straticrestedge wallet cash. Once the product(s) pass our quality check at the warehouse, we will initiate the refund within 24-48 hours. Refunds to your payment method will be processed within 7-10 business days, depending on your bank's processing times. Alternatively, if you opt for  Straticrestedge wallet cash, it will be credited instantly once the product clears the quality check.

Similarly, for COD orders, once the product passes the quality check and reaches our warehouse, the refund will be issued instantly to your  Straticrestedge Wallet.  Straticrestedge Cash can be used for future purchases on our website or app and is valid for 12 months from the date you receive it.`,
      },
      {
        question: "Can I get a refund for a COD order?",
        answer: `Yes, you can get a refund for your COD order, which will be credited to your  Straticrestedge wallet for future purchases.`,
      },
      {
      ...
      },
      {
        ...
        answer: `Please reach out to our customer support team via email or WhatsApp. We will promptly resolve your issue. support@  Straticrestedge solutions private limited`,
      },
      {
    ...
    "My Wallet": [
      {
        ...
        answer:
          "Wallet Credit is the digital money that can be used for future purchases on  Straticrestedge. All the refunds from COD (Cash on Delivery) returns are credited to this virtual wallet.",
      },
      {
        question:
          "Can I transfer the  Straticrestedge Wallet balance to my bank account?",
        answer:
          "No, credit balance is non-transferable and cannot be withdrawn or transferred to a bank account..",
      },
      {
        question: "Does the  Straticrestedge Wallet balance expire?",
        answer:
      ...
      },
      {
        ...
        answer: `To check your  Straticrestedge wallet balance 

Log into your account using your registered mobile number.
Go to "My Account" and select " Straticrestedge Wallet" from the list.
You will see the Available Balance, Total Purchases, and Usage History.`,
      },
      {
        ...
        answer:
          "No, Credits can only be used on  Straticrestedge’s website or mobile app.",
      },
      {
        question: "How to redeem  Straticrestedge wallet balance?",
        answer: `To redeem  Straticrestedge wallet balance -

1. Add your desired product(s) to your cart and proceed to the checkout page.
2. Click on “login to apply”. Once logged in your  Straticrestedge wallet balance will be visible.
...
4. Then continue to checkout, confirm your shipping address and place your order.`,
      ...
      {
        question:
          "Can I use my Wallet balance to purchase from  Straticrestedge’s offline store?",
        answer:
          "No, you cannot use the credit balance to purchase from  Straticrestedge ‘s offline stores.",
      },
    ],
    ...
    Miscellaneous: [
      ...
      },
      {
        ...
        answer:
          "We currently do not offer a trial-and-buy option. To help you choose the right size, we provide a size chart with body measurements on our product pages. If you have any further questions, feel free to contact us on WhatsApp or email us at support@  Straticrestedge solutions private limited.",
      },
      {
        question: "How can I find a  Straticrestedge offline store near me?",
        answer:
    ...
    "Wash Care instructions": [
      {
        question: "How should I care for my  Straticrestedge Plain T-shirt?",
        answer: `The  Straticrestedge Plain T-shirt is built to last, but only if you show it some love. Here’s how to keep it looking fresh:
...
5. Use mild detergents only. Strong ones are a big no-no.`,
      ...
      {
        question: "How do I wash and maintain my  Straticrestedge Plain Shirt?",
        answer: `The  Straticrestedge Plain Shirt is made to keep you looking sharp, but only if you give it the right care. Here’s how to keep it crisp and fresh:
...
4. Air dry for best results, or use a low tumble dry if you are in a hurry.`,
      ...
      {
        question:
          "What should I avoid while washing my  Straticrestedge Polo T-shirt?",
        answer: `The  Straticrestedge Polo T-shirt deserves a little extra care to keep its classy look intact. Here’s what to avoid while washing:
...
4. Say no to harsh detergents. Mild ones will keep it fresh and soft.`,
      ...
      {
        question:
          "What should I keep in mind while washing my  Straticrestedge Regular Fit Pyjamas?",
        answer: `The  Straticrestedge Regular Fit Pyjamas are made for everyday comfort, and with the right care they will stay soft and fresh. Here’s what to keep in mind:
...
4. Never use bleach, as it can weaken the fibers and fade the shade.`,
      ...
      {
        question:
          "Will my  Straticrestedge Loose Fit Pyjamas lose their softness and fit?",
...
4. Never use bleach, as it can weaken the fibers and dull the color.`,
    ...
    "Legitimacy & Reliability": [
      {
        question: "Is  Straticrestedge a Genuine and Legit Website?",
        answer:
          "Yes,  Straticrestedge is a legitimate fashion e-commerce website headquartered in Udaipur, India. With a trusted reputation among over 3 million customers across tier II, III, and IV cities, we adhere to all Indian e-commerce protocols and policies. We constantly adapt to market trends to meet your fashion needs.\n\n Straticrestedge ensures a secure shopping experience through advanced encryption systems that protect all transactions. In case of any issues with incorrect or damaged products, our dedicated customer service team is available to assist with returns, exchanges, or refunds according to our policy.",
      },
      {
        question: "Is  Straticrestedge Real or Fake?",
        answer:
          " Straticrestedge is a genuine and trustworthy brand offering affordable and stylish fashion. We are committed to delivering quality products that reflect the latest trends. Shopping with us means you can expect real, high-quality items and a reliable customer experience. We recommend using  Straticrestedge's official website or mobile app to ensure product authenticity and avoid counterfeits.",
      },
      {
        question: "Is  Straticrestedge a Good Brand Worth Exploring?",
        answer:
          "Absolutely!  Straticrestedge is a well-regarded brand among Indian youngsters, known for transparency and customer satisfaction. Our products receive positive feedback for their quality, comfort, and style. We offer trendy fashion at reasonable prices, making  Straticrestedge a brand worth exploring for stylish, affordable clothing.",
      },
      {
        question:
          "Is It Safe to Buy Clothes from the  Straticrestedge Website? Are the Products of Premium Quality?",
        answer:
          " Straticrestedge is committed to providing a safe and secure shopping experience. Our website and mobile app use the latest HTTPS technology and Secure Sockets Layer (SSL) encryption to protect your data and transactions. We partner with leading payment gateways to ensure your information remains confidential and secure.\n\nWe also prioritize the quality of our products, using premium materials while maintaining affordability. Our packaging ensures your orders arrive damage-free, and our customer support team is dedicated to assisting you with returns and refunds as per our policy.",
      },
    ],
  };
